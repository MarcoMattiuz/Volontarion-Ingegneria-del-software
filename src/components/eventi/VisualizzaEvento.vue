...
<div class="min-h-screen  flex flex-col">
        ...
        <main class="flex-1 flex items-center justify-center p-6">
            <div class="card w-full max-w-3xl shadow-xl rounded-lg p-6 border">
                <!-- Event Image -->
                <figure v-if="event.picture" class="w-full h-80 overflow-hidden rounded-lg">
                    <img :src="event.picture" alt="Event Image" class="w-full h-full object-cover">
                </figure>
                ...
                <div class="card-body text-center space-y-4">
                    ...
                    <!-- Event Date & Time -->
                    <div class=" text-lg">
                        <p><strong>🕒 Start:</strong> {{ formattedDate(event.startDateTime) }}</p>
                        <p><strong>⏳ End:</strong> {{ formattedDate(event.startDateTime) }}</p>
                    </div>
