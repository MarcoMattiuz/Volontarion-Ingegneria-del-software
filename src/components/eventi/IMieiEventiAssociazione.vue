...
import {
  GetMyEventiAssociazioneEndpoint,
  DeleteEventEndpoint,
} from "@/endpoints";
...
<template>
  <div class="max-w-4xl mx-auto p-6">
    <h2 class="text-2xl font-bold text-center mb-6 section-spacing">
      My Events
    </h2>
    ...
    <button
      ...
      @click="showModalCreaEvento = true"
    >
      ➕ Create Event
    </button>
    ...
    <CreaEvento
      v-if="showModalCreaEvento"
      @close="showModalCreaEvento = false"
    />

    <!-- Event list -->
    <div
      v-if="filteredEvents.length > 0 && showModalCreaEvento == false"
    ...
    >
      ...
      >
        ...
        <div class="card-body">
          ...
          <p class="text-gray-500">
            <strong>endDateTime:</strong> {{ event.endDateTime }}
          </p>
          <p class="text-gray-500">
          ...
          <button
            class="btn btn-danger mt-4"
            @click="this.$router.push(`/iscrittiEvento/${event._id}`)"
          >
    ...
    <!-- Event edit modal -->
    <ModificaEvento
      v-if="showModalModificaEvento"
      @close="showModalModificaEvento = false"
      :eventId="editEventId"
